...
<div id="main-container" class="container-fluid">
    <div class="row">
        <div class="offset-md-1 col-md-6 movie-container">
            ...
            allow="accelerometer; autoplay; clipboard-write; enctype-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <div class="col-md-12" id="review-form-container">
                ...
                <form action="<?= $BASE_URL ?>review_process.php" method="POST" id="review-form">
                    ...
                    <div class="form-group">
                        <label for="rating">Nota do filme:</label><br>
